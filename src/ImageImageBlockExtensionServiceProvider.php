...
class ImageImageBlockExtensionServiceProvider extends AddonServiceProvider
{
    ...
    protected $middleware = [
        //Pixney\ImageImageBlockExtension\Http\Middleware\ExampleMiddleware::class
    ];
     ...
     */
    protected $listeners = [
        //Pixney\ImageImageBlockExtension\Event\ExampleEvent::class => [
        //    Pixney\ImageImageBlockExtension\Listener\ExampleListener::class,
        //],
    ];
     ...
     */
    protected $aliases = [
        //'Example' => Pixney\ImageImageBlockExtension\Example::class
    ];
